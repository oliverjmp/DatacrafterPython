...
def exportar_sql(df, ruta, nombre_tabla):
    with open(ruta, 'w', encoding='utf-8') as f:
        ...
        f.write("    entrega_id VARCHAR(10) PRIMARY KEY,\n")
        f.write("    venta_id VARCHAR(10),\n")
        f.write("    fecha_envio DATE,\n")
        f.write("    fecha_entrega DATE,\n")
        f.write("    estado VARCHAR(20),\n")
        f.write("    tipo_entrega VARCHAR(20),\n")
        f.write("    empresa_logistica VARCHAR(50),\n")
        f.write("    cumplimiento_72h VARCHAR(30)\n")
        f.write(");\n\n")
